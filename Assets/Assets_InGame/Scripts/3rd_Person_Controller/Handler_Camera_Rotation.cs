...
#region General Variables
        ...
        #region Basic Camera Requirements:
            #region Transforms
...
//---------------------------------------------------------------------------------------------------------------------
        void Start(){
            ...
            #region Cursor settings (OFF FOR MOBILE):
        ...
        void LateUpdate(){
            if(view.IsMine){
                ...
                #region Set the FINAL angle & circle of camera towards the player:
