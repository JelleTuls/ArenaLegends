...
public class UltimateTouchpadReadmeEditor : Editor
{
	...
	void GettingStarted ()
	{
		...
		GUILayout.Space( paragraphSpace );
		EditorGUILayout.LabelField( "<b>New Input System:</b> In order to reference the Ultimate Touchpad with the new Input System from Unity, simply go to the Script Reference section of the Ultimate Touchpad in your scene and set the Control Path variable to the desired path.", paragraphStyle );
		#endif
	...
	void ImportantChange ()
	{
		...
		EditorGUILayout.LabelField( "Important Changes", sectionHeaderStyle );
		EditorGUILayout.LabelField( "In this update we moved the Ultimate Touchpad folder to be inside a common root folder along with all other Tank & Healer Studio assets. This may cause some strange behavior with the folders for the Ultimate Touchpad, so we advise you to remove the Ultimate Touchpad completely from your project and re-import it to avoid any issues.", paragraphStyle );
