...
public class UltimateTouchpadReadme : ScriptableObject
{
	...
	{
		// VERSION 1.5.1 // IMPORTANT CHANGE 2
		new VersionHistory ()
		{
			versionNumber = "1.5.1",
			changes = new string[]
			{
				...
				"Improved calculations for making the Ultimate Touchpad completely compatible with the new Unity Input System",
				"Updated the README file to not reset every time a script compiles",
			},
		},
		// VERSION 1.5.0 //
		new VersionHistory ()
		{
			...
			changes = new string[]
			{
				...
				"Added new calculations for using Touch Input specifically instead of Unity's EventSystem if the user wants to",
				// Editor Improvements //
